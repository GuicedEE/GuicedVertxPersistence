 ...
 * @since 6.0
 */
public final class JtaPersistOptions
{

  private final boolean autoBeginWorkOnEntityManagerCreation;

  private JtaPersistOptions(Builder builder) {
  ...
  public static final class Builder {
    ...
    public JtaPersistOptions build() {
      return new JtaPersistOptions(this);
    }

    /** Sets the {@link JtaPersistOptions#getAutoBeginWorkOnEntityManagerCreation} property. */
