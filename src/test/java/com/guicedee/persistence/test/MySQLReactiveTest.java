...
/**
 * Integration test for MySQL reactive support using Testcontainers and Hibernate Reactive.
 * <p>
 * Starts a MySQL container, configures the {@link TestModuleMySQLReactive} via system properties,
...
public class MySQLReactiveTest {
    ...
    static final String MYSQL_USER = "test";
    static final String MYSQL_PASSWORD = "test";
    ...
    public static void setup() {
        ...
        System.setProperty("mysql.host", mysqlContainer.getHost());
        System.setProperty("mysql.port", String.valueOf(mysqlContainer.getMappedPort(3306)));
        System.setProperty("mysql.database", MYSQL_DATABASE);
        System.setProperty("mysql.user", MYSQL_USER);
        System.setProperty("mysql.password", MYSQL_PASSWORD);
    ...
    public void testReactiveMySQLConnection() {
        ...
        try {
            ...
            JtaPersistService ps = (JtaPersistService) IGuiceContext.get(
                    Key.get(PersistService.class, Names.named("testMySQLReactive")));
            ...
            Mutiny.SessionFactory sessionFactory = IGuiceContext.get(
                    Key.get(Mutiny.SessionFactory.class, Names.named("testMySQLReactive")));
