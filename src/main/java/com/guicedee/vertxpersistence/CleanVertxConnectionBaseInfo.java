...
public class CleanVertxConnectionBaseInfo extends CleanConnectionBaseInfo {
    ...
    /**
     * Creates a new CleanVertxConnectionBaseInfo instance.
     */
    public CleanVertxConnectionBaseInfo() {
        super();
    }

    /**
     * Creates a new CleanVertxConnectionBaseInfo instance with the specified XA mode.
     *
     * @param xa Whether this is an XA connection
     */
    public CleanVertxConnectionBaseInfo(boolean xa) {
        super();
        setXa(xa);
    }
