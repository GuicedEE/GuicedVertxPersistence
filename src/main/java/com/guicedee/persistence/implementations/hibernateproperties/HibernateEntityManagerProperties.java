 ...
 */
@SuppressWarnings({"unused", "WeakerAccess", "LombokSetterMayBeUsed", "LombokGetterMayBeUsed"})
public class HibernateEntityManagerProperties
		implements IPropertiesEntityManagerReader<HibernateEntityManagerProperties>
{
	/**
