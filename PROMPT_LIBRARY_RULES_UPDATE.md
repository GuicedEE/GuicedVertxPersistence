...
- Library name: Guiced Vert.x Persistence
- Current/new version: 2.0.0-SNAPSHOT
- Repository URL / path: https://github.com/GuicedEE/GuicedVertxPersistence.git
- Rules Repository Location: generative/backend/guicedee/persistence
- Short description: A GuicedEE Util library for configuring Mutiny.SessionFactory injections with Hibernate 7 Reactive
- Type:
...
- Component/topic areas (list): GuicedEE Persistence (Vert.x 5 + Hibernate Reactive 7), Mutiny SessionFactory injection, Lombok, Logging, JSpecify, GitHub Actions CI
